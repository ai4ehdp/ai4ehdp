...
# -----------------------------
if len(sys.argv) < 7:
    print("Usage: python transcribe_by_line_segmentation_folder.py <model_lines> <model_digits> <model_bc> <folder_path> <output_folder> [--clean-masks] [--lines=1,3] [--expand-masks=15] [--save-txt]")
    exit()
