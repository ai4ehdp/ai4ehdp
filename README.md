...
This repository contains supporting source files associated with individual project outputs. The structure of the repository is as follows:

- The `digit_and_glyph_segmentation` branch contains trained AI models and scripts related to the training models and running the segmentation of handwritten digits and glyphs.
